{
  aircraft = "F-14", 
  COM1 = {
    [1] = { freq = 255, color = "Red 1", name = "F14 Intraflight 1" },
    [2] = { freq = 255.1, color = "Red 2", name = "F14 Intraflight 2" },
    [3] = { freq = 255.2, color = "Red 3", name = "F14 Intraflight 3" },
    [4] = { freq = 255.3, color = "Red 4", name = "F14 Intraflight 4" },
  ...
  COM2 = {
    ...
    [13] = { freq = 227.9, color = "Green 5", name = "CVN FINAL" },
    [14] = { freq = 261.3, color = "Amber 1", name = "SENAKI ATIS" },
    [15] = { freq = 261, color = "Amber 2", name = "SENAKI TWR " },
    [16] = { freq = 261.1, color = "Amber 3", name = "SENAKI GND" }
  }
}
